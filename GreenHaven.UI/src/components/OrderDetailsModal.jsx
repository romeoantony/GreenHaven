                      ...
                      <tr key={idx}>
                        <td className="px-4 py-3 text-sm text-gray-900">
                          ...
                          >
                            ...
                            <span className="font-medium text-primary group-hover:text-highlight transition-colors flex items-center gap-1">
                              {item.plantName}
                    ...
                    <div key={idx} className="p-4 flex justify-between items-start">
                      <div className="flex gap-3">
                        ...
                        <div>
                          <button 
                            onClick={() => handlePlantClick(item.plantId)}
                            className="text-sm font-medium text-primary hover:text-highlight transition-colors flex items-center gap-1 text-left"
                          >
                            {item.plantName}
