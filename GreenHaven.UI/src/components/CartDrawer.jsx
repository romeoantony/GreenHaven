      ...
      {isCartOpen && (
        <div className="fixed inset-0 z-50 flex justify-end font-sans">
          ...
          <motion.div 
            ...
            className="absolute inset-0 bg-primary bg-opacity-20 backdrop-blur-sm" 
            onClick={toggleCart}
          />
                ...
                <div className="space-y-6">
                  <AnimatePresence mode="popLayout">
                    {cart.map((item) => (
                      ...
                      >
                        <img src={getImageUrl(item.imageUrl)} alt={item.name} className="w-24 h-24 object-cover rounded-lg shadow-sm" />
